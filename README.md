...
Tools for designing effective choice architectures and decision environments

## Overview

This repository provides resources and tools for choice architecture designer.
...
3. Apply frameworks to your choice architecture designer projects
4. Visit [KeepRule](https://keeprule.com) for additional tools

## About

This project explores choice architecture designer concepts. For structured frameworks from investment masters like Buffett and Munger, visit [KeepRule](https://keeprule.com).
